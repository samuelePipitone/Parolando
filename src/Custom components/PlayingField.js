          ...
          >
            <TouchableOpacity style={styles.containerSfondo} onPress={() => setModalVisible(false)}>
              <View style={styles.modalContainer}>
				...
				<View style={styles.underModalWin}>

					<FontAwesome name="check" color="green" size={width/12}/>
					<Text style={styles.textWin}>Giusto! la parola è: {buildWordle()}</Text>
          ...
          >
            <TouchableOpacity style={styles.containerSfondo} onPress={() => setModalVisible(false)}>
              <View style={styles.modalContainer}>
				...
				<FontAwesome name="close" size={width/12} color="red"/>
				<Text style={styles.textLose}>Peccato! la parola è: {buildWordle()}</Text>
